...
void taskMotorControl(void *pvParameters) {
  ...
  while(true) { // Sonsuz döngü
    // Motor kontrol kodunuz buraya gelecek
...
void controlMotor2() {
    ...
    digitalWrite(PIN_IN1, LOW); // Motorun yönünü saat yönünde kontrol et  
    digitalWrite(PIN_IN2, HIGH);  // Motorun yönünü saat yönünde kontrol et
